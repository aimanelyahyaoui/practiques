...
#exercici 3#
~/practiques$ awk -F,  '{ views = $8 + 0; if(views <= 1000000) {ranking = "Bo";}  else if (views<=10000000 && views>1000000) {ranking = "Excel·lent";}  else {ranking = "Estrella";} print $0 "," ranking;}' sortida2.csv > sortida3.csv
